Summary: IBM MQ SalesForce Bridge
Name: MQSeriesSFBridge
Version: 9.1.2
Release: 0
License: Commercial
...
Requires: MQSeriesJava = 9.1.2-0
Requires: MQSeriesJRE = 9.1.2-0
...
5724-H72 
This package provides the  IBM MQ SalesForce Bridge.
%clean
...
install -d $RPM_BUILD_ROOT/opt/mqm/mqsf
install -d $RPM_BUILD_ROOT/opt/mqm/mqsf/lib
install -d $RPM_BUILD_ROOT/opt/mqm/mqsf/prereqs
install -d $RPM_BUILD_ROOT/opt/mqm/mqsf/samp
install /build/slot1/p910_P/obj/amd64_linux_2/ship/opt/mqm/swidtag/IBM_MQ_SFBridge-9.1.2.mqtag $RPM_BUILD_ROOT/opt/mqm/swidtag/IBM_MQ_SFBridge-9.1.2.mqtag
install /build/slot1/p910_P/obj/amd64_linux_2/ship/opt/mqm/bin/runmqsfb $RPM_BUILD_ROOT/opt/mqm/bin/runmqsfb
install /build/slot1/p910_P/obj/amd64_linux_2/ship/opt/mqm/mqsf/lib/runmqsfb.jar $RPM_BUILD_ROOT/opt/mqm/mqsf/lib/runmqsfb.jar
install /build/slot1/p910_P/obj/amd64_linux_2/ship/opt/mqm/mqsf/prereqs/versionShip.txt $RPM_BUILD_ROOT/opt/mqm/mqsf/prereqs/versionShip.txt
install /build/slot1/p910_P/obj/amd64_linux_2/ship/opt/mqm/mqsf/samp/mqsfbService.mqsc $RPM_BUILD_ROOT/opt/mqm/mqsf/samp/mqsfbService.mqsc
install /build/slot1/p910_P/obj/amd64_linux_2/ship/opt/mqm/mqsf/samp/mqsfbSyncQ.mqsc $RPM_BUILD_ROOT/opt/mqm/mqsf/samp/mqsfbSyncQ.mqsc
install /build/slot1/p910_P/obj/amd64_linux_2/ship/opt/mqm/mqsf/samp/mqsfb.cfg $RPM_BUILD_ROOT/opt/mqm/mqsf/samp/mqsfb.cfg
install /build/slot1/p910_P/obj/amd64_linux_2/ship/opt/mqm/mqsf/samp/pushtopic.apex $RPM_BUILD_ROOT/opt/mqm/mqsf/samp/pushtopic.apex
install /build/slot1/p910_P/obj/amd64_linux_2/ship/opt/mqm/mqsf/samp/README.txt $RPM_BUILD_ROOT/opt/mqm/mqsf/samp/README.txt
install /build/slot1/p910_P/obj/amd64_linux_2/ship/opt/mqm/mqsf/samp/jmsclient.startup.config $RPM_BUILD_ROOT/opt/mqm/mqsf/samp/jmsclient.startup.config
install /build/slot1/p910_P/obj/amd64_linux_2/ship/opt/mqm/mqsf/samp/jmsclient.trace.config $RPM_BUILD_ROOT/opt/mqm/mqsf/samp/jmsclient.trace.config
install /build/slot1/p910_P/obj/amd64_linux_2/ship/opt/mqm/mqsf/prereqs/bayeux-api.jar $RPM_BUILD_ROOT/opt/mqm/mqsf/prereqs/bayeux-api.jar
install /build/slot1/p910_P/obj/amd64_linux_2/ship/opt/mqm/mqsf/prereqs/cometd-java-client.jar $RPM_BUILD_ROOT/opt/mqm/mqsf/prereqs/cometd-java-client.jar
install /build/slot1/p910_P/obj/amd64_linux_2/ship/opt/mqm/mqsf/prereqs/cometd-java-common.jar $RPM_BUILD_ROOT/opt/mqm/mqsf/prereqs/cometd-java-common.jar
install /build/slot1/p910_P/obj/amd64_linux_2/ship/opt/mqm/mqsf/prereqs/jetty-client.jar $RPM_BUILD_ROOT/opt/mqm/mqsf/prereqs/jetty-client.jar
install /build/slot1/p910_P/obj/amd64_linux_2/ship/opt/mqm/mqsf/prereqs/jetty-http.jar $RPM_BUILD_ROOT/opt/mqm/mqsf/prereqs/jetty-http.jar
install /build/slot1/p910_P/obj/amd64_linux_2/ship/opt/mqm/mqsf/prereqs/jetty-io.jar $RPM_BUILD_ROOT/opt/mqm/mqsf/prereqs/jetty-io.jar
install /build/slot1/p910_P/obj/amd64_linux_2/ship/opt/mqm/mqsf/prereqs/jetty-util-ajax.jar $RPM_BUILD_ROOT/opt/mqm/mqsf/prereqs/jetty-util-ajax.jar
install /build/slot1/p910_P/obj/amd64_linux_2/ship/opt/mqm/mqsf/prereqs/jetty-util.jar $RPM_BUILD_ROOT/opt/mqm/mqsf/prereqs/jetty-util.jar
install /build/slot1/p910_P/obj/amd64_linux_2/ship/opt/mqm/mqsf/prereqs/JSON4J.jar $RPM_BUILD_ROOT/opt/mqm/mqsf/prereqs/JSON4J.jar
install /build/slot1/p910_P/obj/amd64_linux_2/ship/opt/mqm/mqsf/prereqs/slf4j-api.jar $RPM_BUILD_ROOT/opt/mqm/mqsf/prereqs/slf4j-api.jar
install /build/slot1/p910_P/obj/amd64_linux_2/ship/opt/mqm/mqsf/prereqs/slf4j-simple.jar $RPM_BUILD_ROOT/opt/mqm/mqsf/prereqs/slf4j-simple.jar

%files
%dir %attr(555,mqm,mqm) "/opt/mqm"
%dir %attr(555,mqm,mqm) "/opt/mqm/swidtag"
%dir %attr(555,mqm,mqm) "/opt/mqm/bin"
%dir %attr(555,mqm,mqm) "/opt/mqm/mqsf"
%dir %attr(555,mqm,mqm) "/opt/mqm/mqsf/lib"
%dir %attr(555,mqm,mqm) "/opt/mqm/mqsf/prereqs"
%dir %attr(555,mqm,mqm) "/opt/mqm/mqsf/samp"
%attr(444,mqm,mqm) "/opt/mqm/swidtag/IBM_MQ_SFBridge-9.1.2.mqtag"
%attr(555,mqm,mqm) "/opt/mqm/bin/runmqsfb"
%attr(444,mqm,mqm) "/opt/mqm/mqsf/lib/runmqsfb.jar"
%attr(444,mqm,mqm) "/opt/mqm/mqsf/prereqs/versionShip.txt"
%attr(444,mqm,mqm) "/opt/mqm/mqsf/samp/mqsfbService.mqsc"
%attr(444,mqm,mqm) "/opt/mqm/mqsf/samp/mqsfbSyncQ.mqsc"
%attr(444,mqm,mqm) "/opt/mqm/mqsf/samp/mqsfb.cfg"
%attr(444,mqm,mqm) "/opt/mqm/mqsf/samp/pushtopic.apex"
%attr(444,mqm,mqm) "/opt/mqm/mqsf/samp/README.txt"
%attr(444,mqm,mqm) "/opt/mqm/mqsf/samp/jmsclient.startup.config"
%attr(444,mqm,mqm) "/opt/mqm/mqsf/samp/jmsclient.trace.config"
%attr(444,mqm,mqm) "/opt/mqm/mqsf/prereqs/bayeux-api.jar"
%attr(444,mqm,mqm) "/opt/mqm/mqsf/prereqs/cometd-java-client.jar"
%attr(444,mqm,mqm) "/opt/mqm/mqsf/prereqs/cometd-java-common.jar"
%attr(444,mqm,mqm) "/opt/mqm/mqsf/prereqs/jetty-client.jar"
%attr(444,mqm,mqm) "/opt/mqm/mqsf/prereqs/jetty-http.jar"
%attr(444,mqm,mqm) "/opt/mqm/mqsf/prereqs/jetty-io.jar"
%attr(444,mqm,mqm) "/opt/mqm/mqsf/prereqs/jetty-util-ajax.jar"
%attr(444,mqm,mqm) "/opt/mqm/mqsf/prereqs/jetty-util.jar"
%attr(444,mqm,mqm) "/opt/mqm/mqsf/prereqs/JSON4J.jar"
%attr(444,mqm,mqm) "/opt/mqm/mqsf/prereqs/slf4j-api.jar"
%attr(444,mqm,mqm) "/opt/mqm/mqsf/prereqs/slf4j-simple.jar"

%pre
RPM_PACKAGE_SUMMARY="IBM MQ SalesForce Bridge"
RPM_PACKAGE_NAME="MQSeriesSFBridge"
...
# @(#) MQMBID sn=p912-L190308 su=_o4gl9UGHEemzP9qe_wddSA pn=install/unix/linux_2/restbridge_preinstall.sh
#   <copyright
#   notice="lm-source-program"
#   pids="5724-H72"
#   years="2005,2018"
...
#   </copyright>
#
# Preinstall script for the Blockchain and Salesforce Bridges to
# remove any of the 9.0.x prereq jars as they had version numbers
# which could cause upgrade problems with duplicate classes

# This file was shipped in both bridge packages at 9.0.x
checkJar="slf4j-api-1.7.21.jar"
echo ${RPM_PACKAGE_NAME} | grep  "MQSeriesSFBridge" > /dev/null
if [ $? -eq 0 ] ; then
  subdir="mqsf"
  desc="MQ Bridge for Salesforce"
else
  subdir="mqbc"
  desc="MQ Bridge for Blockchain"
fi

prereqdir=$MQ_INSTALLATION_PATH/$subdir/prereqs
if [ -r $prereqdir/$checkJar ]
then
  echo "You appear to have the $desc V9.0 still installed. " 
